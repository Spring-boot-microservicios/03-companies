package com.angelfg.companiescrud.controllers;
...
//        Para probar el circuit breaker por latencia en ms-reports
//        try {
    ...
    @Operation(summary = "update in DB a company given a company form body")
